...
set SRC= src/core/render/Shader.cpp src/core/scene/Entity.cpp src/core/scene/Scene.cpp src/core/scene/SceneModule.cpp src/core/WindowModule.cpp src/core/State.cpp src/main.cpp
